        ...
        try:
            ...
            # pass
                ...
                privilege = [{key: value[0]} for key, value in zip(dataset['aif_dataset'].protected_attribute_names,
                                                                   dataset[
                                                                       'aif_dataset'].privileged_protected_attributes)]
                ...
                # RawDataSet
                train_data = RawDataSet(x=np.delete(dataset_train.features, protected_idx, axis=1),
                                        y=dataset_train.labels.ravel(), z=biased)
                test_data = RawDataSet(x=np.delete(dataset_test.features, protected_idx, axis=1),
                                       y=dataset_test.labels.ravel(), z=biased)
